#!/usr/bin/env python3
"""Generate output JSON variants and create struct output."""
import json
import os
...
# Create mini version (keep structure, limit data)
...
# Create preview version (same as mini)
...
# Check file sizes
for fname in ['output/method_out.json', 'output/full_method_out.json', 
              'output/mini_method_out.json', 'output/preview_method_out.json']:
